...
```
Error: locator.click: Error: strict mode violation: locator('.tta-button') resolved to 2 elements:
    1) <button type="button" class="tta-button" id="select-cloud-qa">Select Cloud QA</button> aka getByRole('button', { name: 'Select Cloud QA' })
    2) <button type="button" id="clear-selection" class="tta-button is-secondary">Clear</button> aka getByRole('button', { name: 'Clear' })

Call log:
  - waiting for locator('.tta-button')
