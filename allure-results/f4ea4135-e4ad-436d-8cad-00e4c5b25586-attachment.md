...
Call log:
  - waiting for getByTestId('select-cloud-qa')
...
```ts
  ...
  7  |   
  8  | 
  9  |     //await page.locator('.tta-button').click();    
  10 |     //await page.getByText('Select Cloud QA', { exact: true }).click();
> 11 |     await page.getByTestId('select-cloud-qa').click();
     |                                               ^ Error: locator.click: Test timeout of 30000ms exceeded.
  12 |     
  13 | });
```