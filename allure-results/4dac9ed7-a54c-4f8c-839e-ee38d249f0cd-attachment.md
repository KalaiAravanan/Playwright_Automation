...
Call log:
  - waiting for locator('#vehicle-registration-card').contentFrame().locator('#RESULT_TextField-1')
...
```ts
  ...
  6  | 
> 7  |         await page.frameLocator('#vehicle-registration-card').locator('#RESULT_TextField-1').fill('A232K');
     |                                                                                              ^ Error: locator.fill: Test timeout of 30000ms exceeded.
  8  |         
